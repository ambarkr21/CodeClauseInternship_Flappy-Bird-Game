...
while True:
    ...
    if is_off_screen(pipe_group.sprites()[0]):
        ...
        pipe_group.add(pipes[0])
        pipe_group.add(pipes[1])
        score += 1  # Increase score when pipes are passed
...
final_score_surface = font.render('Score: ' + str(score), True, (255, 255, 255))
screen.blit(final_score_surface, (SCREEN_WIDTH / 2 - final_score_surface.get_width() / 2, SCREEN_HEIGHT / 2 + GAME_OVER_IMAGE.get_height() / 2 + 10))
pygame.display.update()
time.sleep(3)
pygame.quit()
